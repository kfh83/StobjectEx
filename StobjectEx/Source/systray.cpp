...
EXTERN_C DWORD g_uiShellHook; //shell hook window message
...
UINT EnableService(UINT uNewSvcMask, BOOL fEnable)
{
        ...
        REG_OPTION_NON_VOLATILE, KEY_READ | KEY_SET_VALUE, NULL, &hk, NULL) == ERROR_SUCCESS)
    {
        ...
        if (uNewSvcMask)
        {
            ...
            RegSetValueEx(hk, REGSTR_VAL_SYSTRAYSVCS, 0, REG_DWORD, (LPCBYTE)&uCurSvcMask, sizeof(uCurSvcMask));
        }
...
//                break;
    ...
    case WM_HELP:
        // WinHelp(((LPHELPINFO)lParam)->hItemHandle, NULL, HELP_WM_HELP,(ULONG_PTR)(LPSTR)g_ContextMenuHelpIDs);
        break;
